...
// Create restaurant with account (Admin only)
export const createRestaurantWithAccount = async(data) => {
    const response = await axios.post('/restaurants/create-with-account', data);
    return response.data;
};
