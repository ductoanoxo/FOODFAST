...
- **Máy chủ Production:** AWS EC2  
  🌍 **Public IP (hiện tại):** `34.207.80.229`  
...
| Ứng dụng | Mô tả | URL |
|----------|--------|------|
| 👥 **Client (Người dùng)** | Đặt món, thanh toán, theo dõi đơn hàng | [http://34.207.80.229:3000](http://34.207.80.229:3000) |
| 🍴 **Restaurant (Nhà hàng)** | Quản lý đơn hàng, menu, doanh thu | [http://34.207.80.229:3001](http://34.207.80.229:3001) |
| 🧑‍💼 **Admin Dashboard** | Quản trị hệ thống toàn bộ | [http://34.207.80.229:3002](http://34.207.80.229:3002) |
| ⚙️ **Backend API** | REST API trung tâm | [http://34.207.80.229:5000](http://34.207.80.229:5000) |
...
- **Lưu ý:**  
  - Không nên hard-code IP (`http://34.207.80.229:5000`) trong build args.  
...
```bash
ssh -i "C:/Users/ADMIN/Downloads/CNPM_AWS_SGU.pem" ubuntu@34.207.80.229
```
