...
- **Máy chủ Production:** AWS EC2  
  🌍 **Public IP (hiện tại):** `54.166.228.50`  
...
| Ứng dụng | Mô tả | URL |
|----------|--------|------|
| 👥 **Client (Người dùng)** | Đặt món, thanh toán, theo dõi đơn hàng | [http://54.166.228.50:3000](http://54.166.228.50:3000) |
| 🍴 **Restaurant (Nhà hàng)** | Quản lý đơn hàng, menu, doanh thu | [http://54.166.228.50:3001](http://54.166.228.50:3001) |
| 🧑‍💼 **Admin Dashboard** | Quản trị hệ thống toàn bộ | [http://54.166.228.50:3002](http://54.166.228.50:3002) |
| ⚙️ **Backend API** | REST API trung tâm | [http://54.166.228.50:5000](http://54.166.228.50:5000) |
...
- **Lưu ý:**  
  - Không nên hard-code IP (`http://54.166.228.50:5000`) trong build args.  
