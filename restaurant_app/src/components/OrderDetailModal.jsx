...
const statusConfig = {
  ...
  waiting_for_customer: { color: 'gold', text: 'Chờ khách nhận', icon: <ClockCircleOutlined /> },
  delivery_failed: { color: 'volcano', text: 'Giao hàng thất bại', icon: <WarningOutlined /> },
  returning_to_restaurant: { color: 'orange', text: 'Đang trả về', icon: <SyncOutlined spin /> },
  returned: { color: 'magenta', text: 'Đã trả về', icon: <CheckCircleOutlined /> },
