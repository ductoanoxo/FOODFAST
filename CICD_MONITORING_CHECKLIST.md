...
Open: http://13.220.101.54:3030/d/foodfast-cicd
...
- [ ] Try manual curl:
```bash
curl -X POST http://13.220.101.54:9091/metrics/job/test \
  --data-binary @- <<EOF
