...
### 3. Xem Dashboard
- Mở: http://3.89.225.219:3030/d/foodfast-cicd
...
Export Metrics Workflow triggers tự động
    ↓
Push metrics → Pushgateway (http://3.89.225.219:9091)
    ↓
Prometheus scrape mỗi 10s (http://3.89.225.219:9090)
    ↓
Grafana hiển thị real-time (http://3.89.225.219:3030)
    ↓
...
| Grafana | http://3.89.225.219:3030 | admin/admin123 |
| Dashboard | http://3.89.225.219:3030/d/foodfast-cicd | admin/admin123 |
...
Sau đó mở: http://3.89.225.219:3030/d/foodfast-cicd
