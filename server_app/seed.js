...
const seedData = async () => {
  try {
    ...
    const categories = await Category.create([
      { name: 'Cơm', description: 'Các món cơm', image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/com.jpg' },
      { name: 'Phở', description: 'Các món phở', image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/pho.jpg' },
      { name: 'Bún', description: 'Các món bún', image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/bun.jpg' },
      { name: 'Đồ uống', description: 'Nước giải khát', image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/nuocgiakhat.jpg' },
      { name: 'Fastfood', description: 'Đồ ăn nhanh', image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/doannhanh.jpg' },
    ]);
    ...
    const restaurants = await Restaurant.create([
      {
        ...
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/comtam.jpg',
        rating: 4.5,
        reviewCount: 125,
        address: '123 Nguyen Hue, District 1, HCM City',
        phone: '0281234567',
      ...
      },
      {
        ...
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/pho.jpg',
        rating: 4.7,
        reviewCount: 89,
        address: '456 Le Loi, District 1, HCM City',
        phone: '0281234568',
      ...
      },
      {
        ...
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/KFC.jpg',
        rating: 4.3,
        reviewCount: 234,
        address: '789 Tran Hung Dao, District 5, HCM City',
        phone: '0281234569',
    ...
    const products = await Product.create([
      ...
      },
      {
        ...
        price: 35000,
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/comtamsuonbicha.jpg',
        category: categories[0]._id,
        restaurant: restaurants[0]._id,
        stock: 100,
        rating: 4.5,
      ...
      },
      {
        ...
        price: 65000,
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/garan.jpg',
      ...
      },
      {
        ...
        price: 95000,
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/garanburger.jpg',
        category: categories[4]._id,
        restaurant: restaurants[2]._id,
        stock: 120,
        rating: 4.5,
      ...
      },
      {
        ...
        price: 5000,
        image: 'https://res.cloudinary.com/dp4o6la8b/image/upload/v1761115010/trada.jpg',
