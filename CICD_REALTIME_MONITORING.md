...
```bash
curl http://13.220.101.54:9091/metrics | grep -A5 "github_workflow_run_total"
```
...
```bash
# Vào Prometheus UI
# http://13.220.101.54:9090/targets
...
- **Dashboard**: http://13.220.101.54:3030/d/foodfast-cicd
...
echo "   curl http://13.220.101.54:9091/metrics | grep github_workflow_run_total"
echo ""
